For the following index.js explain pr rather give reponce
...
const { atyping } = require(__dirname + '/LOU_MD_DB/atyping')
const { arecording } = require(__dirname + '/LOU_MD_DB/recording')
const { aonline } = require(__dirname + '/LOU_MD_DB/online')
...
const { cmd, commands,Module_Exports,Function,smd } = require(__dirname + '/lou-md_plugins')
